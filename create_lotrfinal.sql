CREATE DATABASE  IF NOT EXISTS `lotrfinal` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `lotrfinal`;
-- MySQL dump 10.13  Distrib 8.0.17, for macos10.14 (x86_64)
--
-- Host: localhost    Database: lotrfinal
-- ------------------------------------------------------
...
--
-- Dumping events for database 'lotrfinal'
--

--
-- Dumping routines for database 'lotrfinal'
--
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `track_character`(IN character_input CHAR(20))
BEGIN
    SELECT character_name, character2_name, region_name
    FROM lotr_character
    INNER JOIN lotr_first_encounter
    ON lotr_character.character_name = lotr_first_encounter.character1_name
    WHERE character1_name=character_input OR character2_name=character_input;
END ;;
DELIMITER ;
...
-- Dump completed on 2019-11-16 20:25:05
